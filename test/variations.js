...
describe('variations', function() {
  ...
  it('recomputes cbox and advance width', function() {
    ...
    return assert.equal(Math.round(glyph.cbox.minX * 100) / 100, 179.02);
  });
});
